...
| Property | Type | Required | Description                                                                                                                                                                     |
|----------|------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `object` |      | No       | Possible types are: `[DateHistogram](#DateHistogram)`, `[Histogram](#Histogram)`, `[Terms](#Terms)`, `[Filters](#Filters)`, `[GeoHashGrid](#GeoHashGrid)`, `[Nested](#Nested)`. |
...
| Property | Type | Required | Description                                                                                                |
|----------|------|----------|------------------------------------------------------------------------------------------------------------|
| `object` |      | No       | Possible types are: `[Count](#Count)`, `[PipelineMetricAggregation](#PipelineMetricAggregation)`, `[](#)`. |
...
| Property | Type | Required | Description                                                                                                                                             |
|----------|------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| `object` |      | No       | Possible types are: `[MovingAverage](#MovingAverage)`, `[Derivative](#Derivative)`, `[CumulativeSum](#CumulativeSum)`, `[BucketScript](#BucketScript)`. |
