...
| `bucketAggs` | DateHistogram | Histogram | Terms | Filters | GeoHashGrid | Nested | No       | List of bucket aggregations                                                                                                                                                                                                                                                                            |
...
| `metrics`    | Count | PipelineMetricAggregation |                                | No       | List of metric aggregations                                                                                                                                                                                                                                                                            |
...
| Property   | Type                | Required | Description                                                                                                                                |
|------------|---------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------------|
| `field`    | string              | No       | *(Inherited from [Nested](#nested))*                                                                                                       |
| `id`       | string              | No       | *(Inherited from [Nested](#nested))*                                                                                                       |
| `settings` | [object](#settings) | No       | *(Inherited from [Nested](#nested))*                                                                                                       |
| `type`     | string              | No       | *(Inherited from [Nested](#nested))*<br/>Possible values are: `terms`, `filters`, `geohash_grid`, `date_histogram`, `histogram`, `nested`. |
...
| `settings`          | [object](#settings)                     | No       |                                                                                                                                                                                                                                                                 |
| `type`              | string                                  | No       | Possible values are: `count`, `avg`, `sum`, `min`, `max`, `extended_stats`, `percentiles`, `cardinality`, `raw_document`, `raw_data`, `logs`, `rate`, `top_metrics`, `moving_avg`, `moving_fn`, `derivative`, `serial_diff`, `cumulative_sum`, `bucket_script`. |
...
| Property            | Type                                    | Required | Description                                                                                                                                                                                                                                                                                                          |
|---------------------|-----------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `field`             | string                                  | No       | *(Inherited from [CumulativeSum](#cumulativesum))*                                                                                                                                                                                                                                                                   |
| `hide`              | boolean                                 | No       | *(Inherited from [BucketScript](#bucketscript))*                                                                                                                                                                                                                                                                     |
| `id`                | string                                  | No       | *(Inherited from [BucketScript](#bucketscript))*                                                                                                                                                                                                                                                                     |
| `pipelineAgg`       | string                                  | No       | *(Inherited from [CumulativeSum](#cumulativesum))*                                                                                                                                                                                                                                                                   |
| `pipelineVariables` | [PipelineVariable](#pipelinevariable)[] | No       | *(Inherited from [BucketScript](#bucketscript))*                                                                                                                                                                                                                                                                     |
| `settings`          | [object](#settings)                     | No       | *(Inherited from [BucketScript](#bucketscript))*                                                                                                                                                                                                                                                                     |
| `type`              | string                                  | No       | *(Inherited from [BucketScript](#bucketscript))*<br/>Possible values are: `count`, `avg`, `sum`, `min`, `max`, `extended_stats`, `percentiles`, `cardinality`, `raw_document`, `raw_data`, `logs`, `rate`, `top_metrics`, `moving_avg`, `moving_fn`, `derivative`, `serial_diff`, `cumulative_sum`, `bucket_script`. |
