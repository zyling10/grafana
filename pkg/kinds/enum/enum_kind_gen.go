...
const rootrel string = "kinds/enum"

// TODO standard generated docs
type Kind struct {
	kindsys.Core
	lin    thema.ConvergentLineage[*Enum]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Enum]
}
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Enum](cursch, &Enum{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("enum.json")
...
// to the the Enum type generated from the current schema, v0.0.
func (k *Kind) ConvergentLineage() thema.ConvergentLineage[*Enum] {
	return k.lin
}

// JSONValueMux is a version multiplexer that maps a []byte containing JSON data
// at any schematized dashboard version to an instance of Enum.
//
// Validation and translation errors emitted from this func will identify the
// input bytes as "dashboard.json".
//
// This is a thin wrapper around Thema's [vmux.ValueMux].
func (k *Kind) JSONValueMux(b []byte) (*Enum, thema.TranslationLacunas, error) {
	return k.valmux(b)
}
