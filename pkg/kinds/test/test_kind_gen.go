...
const rootrel string = "kinds/test"

// TODO standard generated docs
type Kind struct {
	lin    thema.ConvergentLineage[*Test]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Test]
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Test](cursch, &Test{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("test.json")
...
// representing the static properties declared in the test kind.
//
